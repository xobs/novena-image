...
exec sudo ./novena-image.sh \
	...
	-l "sudo openssh-server ntp ntpdate dosfstools novena-eeprom \
            xserver-xorg-video-modesetting task-xfce-desktop \
	    hicolor-icon-theme gnome-icon-theme tango-icon-theme keychain \
	    avahi-daemon avahi-dnsconfd libnss-mdns dosfstools debootstrap \
	    python build-essential xscreensaver vlc vim emacs \
	    ...
	    network-manager-pptp network-manager-openvpn \
	    network-manager-iodine libreoffice icedove iceweasel gnupg2 git \
